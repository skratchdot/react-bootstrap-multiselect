...
gulp.task('download', function() {
  ...
  download(
    'https://raw.githubusercontent.com/davidstutz/bootstrap-multiselect/master/dist/less/bootstrap-multiselect.less'
  ).pipe(gulp.dest('./less/'));
...
gulp.task('get-options', function() {
  ...
  var defaults =
    $.fn.multiselect.prototype.constructor.Constructor.prototype.defaults;

  // get default plugin options
  var options = Object.keys(defaults)
    .sort()
    .map(function(opt) {
...
gulp.task('bootstrap-dropdown', function() {
  gulp
    .src('./node_modules/bootstrap/js/dropdown.js')
    .pipe(
      wrap(
...
gulp.task('bootstrap-multiselect', function() {
  gulp
    .src('./lib/bootstrap-multiselect-original.js')
    .pipe(
      wrap(
...
gulp.task('watch', function() {
  gulp.watch(
    ['./gulpfile.js', './lib/**/*.js', './demo/src/**/*.js'],
    ['build']
  );
});
